package cn.jxau.bookstore.order.web.servlet;
...
import cn.jxau.bookstore.order.domain.OrderItem;
import cn.jxau.bookstore.order.service.OrderService;
...
public class OrderServlet extends BaseServlet {
	...
	public String add(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (CartItem cartItem : cart.getCartItems()) {
			...
			oi.setSubtotal(cartItem.getSubtotal());// 设置单价
			oi.setOrder(order);// 设置订单者
		...
		// 保存到request域中，转发到order/desc.jsp
